...
class AddVehiclePage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            //PLAT NOMOR
            SubtitleText(text: "Plate Number"),
            Row(
            ...
            Padding(
              ...
              child: Obx(
                () => DropdownSearch<String>(
                  ...
                  selectedItem: _selectedItem.value ?? "Type of Vehicle",
  ...
  void addVehicle() async {
    ...
    if (brand.isEmpty ||
      ...
      Get.snackbar("An Error Occurred", "All data must be filled");
    } else {
      String type = _selectedItem.value! == "Car" ? "B" : "T";
      await ApiServices.addVehicle(
        ...
        Get.snackbar("Success", "Successfully Added Vehicle");
      });
    }
  }
}
