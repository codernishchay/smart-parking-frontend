      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SubtitleText(text: "Nominal Type"),
            ...
            //TITLE KETIKAN NOMINAL fill the balance
            SubtitleText(text: "Select Nominal"),

            //WIDGET LIST PILIHAN NOMINAL fill the balance
            Container(
  ...
  void topUp() async {
    ...
    await ApiServices.topUp(
      ...
      (value) {
        ...
        Get.snackbar("Successful", "Successful top up balance");
      },
    );
  }
