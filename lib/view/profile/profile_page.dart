...
class ProfilePage extends StatelessWidget {
      ...
      body: FutureBuilder<User>(
        ...
        builder: (context, snapshot) {
          if (snapshot.data == null) {
            ...
            _tfName.text = snapshot.data!.name;
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //TITLE
                  Text(
                    "All information about personal data and your account.",
                    style: TextStyle(
                      fontSize: 16,
                      height: 2,
  ...
  void editProfile() async {
    await ApiServices.editProfile(
      ...
      (val) => Get.snackbar(
        val.error == true ? "Error Occured" : "Profile updated",
        val.message,
      ),
    );
  }
