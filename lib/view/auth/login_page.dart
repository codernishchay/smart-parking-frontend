...
class LoginPage extends StatelessWidget {
  ...
  final _tfEmail = TextEditingController(text: "nishchay.v19@iiits.in");
  ...
  Future<void> doLogin() async {
    ...
    //   (data) async {
        ...
        //   _isLoading.value = !_isLoading.value;
          Get.offAndToNamed('${NavBar.TAG}/nishchay');
        // }
      // },
    // );
  }
  ...
  loginFailed() {
    ...
    Get.defaultDialog(
      ...
      content: Text(
        "Login email/password is invalid or incorrect",
