        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Direct the QR Code to the automatic parking bar machine when you want to login to the parking area",
                style: TextStyle(
            ...
            //PILIH KENDDARAAN
            SubtitleText(text: "Select Vehicle"),
            Padding(
              ...
              child: DropdownSearch<Vehicle>(
                ...
                dropdownBuilder: (context, selectedItem) {
                  return Text(selectedItem?.model ?? "Select Vehicle");
                },
                popupProps: PopupProps.modalBottomSheet(
                  ...
                  itemBuilder: (context, item, isSelected) {
                    return ListTile(
                      ...
                      subtitle: Text(
                        "${item.noPolisi} • ${item.jenis == 'B' ? "Car" : "Motar Cycle"} • ${item.color}",
                  ...
                  emptyBuilder: (context, item) {
                    return Column(
                      ...
                      children: [
                        Text(
                          "Oops! You haven't added your vehicle yet, add your vehicle first :D",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            height: 1.75,
                            color: ColorsTheme.myGrey,
